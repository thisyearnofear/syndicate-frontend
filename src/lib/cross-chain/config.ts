...
export const ACROSS_INTEGRATOR_ID = process.env.NEXT_PUBLIC_ACROSS_INTEGRATOR_ID || "0xdead";
export const USE_TESTNET = !isProduction;

// Testnet token addresses
export const GRASS_ADDRESS_LENS_TESTNET = "0x000000000000000000000000000000000000800A"; // GRASS on Lens Testnet (native token)
export const WGRASS_ADDRESS_LENS_TESTNET = "0xeee5a340Cdc9c179Db25dea45AcfD5FE8d4d3eB8"; // Wrapped GRASS on Lens Testnet
export const WETH_ADDRESS_LENS_TESTNET = "0xaA91D645D7a6C1aeaa5988e0547267B77d33fe16"; // WETH on Lens Testnet
export const USDC_ADDRESS_BASE_SEPOLIA = "0x036CbD53842c5426634e7929541eC2318f3dCF7e"; // USDC on Base Sepolia
...
// Token addresses
export const USDC_ADDRESS_LENS = process.env.NEXT_PUBLIC_USDC_ADDRESS_LENS || "0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359"; // USDC on Lens Chain
...
export const GHO_ADDRESS_LENS = process.env.NEXT_PUBLIC_GHO_ADDRESS_LENS || "0x6bDc36E20D267Ff0dd6097799f82e78907105e2F"; // GHO on Lens Chain
export const GHO_ADDRESS_ETHEREUM = process.env.NEXT_PUBLIC_GHO_ADDRESS_ETHEREUM || "0x1ff1dC3cB9eeDbC6Eb2d99C03b30A05cA625fB5a"; // GHO on Ethereum
export const USDC_ADDRESS_ETHEREUM = process.env.NEXT_PUBLIC_USDC_ADDRESS_ETHEREUM || "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"; // USDC on Ethereum

// Bridge addresses
export const ACROSS_BRIDGE_LENS = process.env.NEXT_PUBLIC_ACROSS_BRIDGE_LENS || "0xe7cb3e167e7475dE1331Cf6E0CEb187654619E12"; // Across bridge on Lens Chain
export const ACROSS_BRIDGE_BASE = process.env.NEXT_PUBLIC_ACROSS_BRIDGE_BASE || "0x09aea4b79ec8780a2d3a7615fa28b9c90f702071"; // Across bridge on Base
...
export const CHAINS = {
  ...
  [ChainId.LENS_TESTNET]: {
    ...
    rpcUrl: process.env.NEXT_PUBLIC_LENS_TESTNET_RPC_URL || "https://rpc.testnet.lens.xyz",
  ...
  [ChainId.ETHEREUM_SEPOLIA]: {
    ...
    rpcUrl: process.env.NEXT_PUBLIC_ETHEREUM_SEPOLIA_RPC_URL || "https://sepolia.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161",
