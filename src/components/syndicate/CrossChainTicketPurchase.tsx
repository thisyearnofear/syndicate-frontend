...
export function CrossChainTicketPurchase({
  syndicateId,
    ...
    if (isConfirming) {
      try {
        await purchaseTickets({
          ...
          usdcAddressSource: USDC_ADDRESS_LENS,
          usdcAddressDestination: USDC_ADDRESS_BASE,
          ticketAmount: ticketCount,
          ticketPriceInUSDC,
          megapotContractAddress: MEGAPOT_CONTRACT_ADDRESS,
          syndicateRegistryAddress: SYNDICATE_REGISTRY_ADDRESS,
      ...
      <div className="space-y-4">
        ...
        <div className="bg-black/20 p-3 rounded-md">
          <div className="flex justify-between mb-1">
            ...
            <span>${ticketPriceInUSDC.toFixed(2)} USDC</span>
          </div>
          <div className="flex justify-between mb-1">
